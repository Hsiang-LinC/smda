...
```bash
~/.codex/plugins/cache/smda/smda-automation/0.3.1/runtime/smda validate-config /path/to/repo/smda.config.json --repo-root /path/to/repo
~/.codex/plugins/cache/smda/smda-automation/0.3.1/runtime/smda validate-context /path/to/repo/smda.config.json --repo-root /path/to/repo
```
...
`Hsiang-LinC/smda-plugin-dist`. The release configured by this source revision is `v0.3.1`.
